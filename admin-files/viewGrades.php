                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex flex-row">
                                ...
                                <p class="text-capitalize"> <?= $row['lName'] . ', ' . $row['fName'] . ' ' . $row['mName'] ?></p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="fw-bold px-2">Course:</p>
                                <p class="text-uppercase"><?= $row['courseName'] ?></p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex flex-row">
                                <p class="fw-bold px-2">Year:</p>
                                <p class="text-uppercase"> <?= $row['year'] ?> </p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="fw-bold px-2">Section:</p>
                                <p class="text-uppercase"> <?= $row['section'] ?> </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row2 = $resultSubjects->fetch_assoc()) { ?>
                                        ...
                                        <tr class="text-center">
                                            <td><?= $row2['subjectName'] ?></td>
                                            <td><?= $row2['instructor'] ?></td>
                                     
                                                <td> <input type="number" class="form-control" name="prelims"  id=""> </td>
                                                <td> <input type="number" class="form-control" name="midterm" id=""> </td>
                                                <td> <input type="number" class="form-control" name="finals" id=""> </td>
                                           
                                            <td><input type="number" class="form-control-plaintext" name="" id=""></td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <!-- hidden -->
                                                <input type="text" name="studentID" id="" value="<?= $row['studentID'] ?>">
                                                <input type="text" name="subjectID" id="" value="<?= $row2['subjectID'] ?>">
